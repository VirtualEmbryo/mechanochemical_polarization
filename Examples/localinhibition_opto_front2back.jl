...
vCTE= 0# -0.15 #Scale for the polimerizatio velocity
...
const simulation= "Opto_activation_local_inhibition/T=$T ten0=$ten0 db=$dᵇ da=$dᵃ sig0=$sig0 rth=$ρth len=$len/bopto=$βopto aopto=$αopto rho0=$rho0 mTorc=$mTorc D=$D a0=$α₀ b0=$β₀ te=$τₑ ta=$τₐ M0=$M0 deltat=$Δt vCTE=$vCTE tenth=$tenth lb=$λᵇ/"
